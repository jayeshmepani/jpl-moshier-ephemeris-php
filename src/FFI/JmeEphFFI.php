...
/**
 * JmeEphFFI - Pure JME PHP Wrapper (V2 - Verified Constants)
 */
class JmeEphFFI
{
    ...
    public const JME_AU_KM = 149597870.700;
    public const JME_BIT_ASTRO_TWILIGHT = 512;
    public const JME_BIT_CIVIL_TWILIGHT = 128;
    public const JME_BIT_DISC_BOTTOM = 2048;
    public const JME_BIT_DISC_CENTER = 256;
    public const JME_BIT_HINDU_RISING = 4096;
    public const JME_BIT_NAUTIC_TWILIGHT = 64;
    public const JME_BIT_NO_REFRACTION = 8192;
    ...
    public const JME_CALC_APPARENT_POSITION = 273;
    public const JME_CALC_ASTROMETRIC = 1024;
    public const JME_CALC_BARYCENTRIC = 16;
    public const JME_CALC_CENTER_BODY = 4096;
    public const JME_CALC_DISTANCE_AU = 4097;
    ...
    public const JME_CALC_ITRANSIT = 8;
    public const JME_CALC_J2000 = 128;
    public const JME_CALC_MTRANSIT = 4;
    ...
    {
        $cdef = "const char *jme_version(char *buffer, size_t buffer_size);
    void jme_close(void);
    ...
    int jme_moshier_planet_state(double jd_et, int body, double *results);";
        ...
        if ($libraryPath === null) {
            $libraryPath = '/home/shreesoftech/projects/test1/astro_packages/jpl-ephemeris-/build/libjme.so';
        }
    ...
    public function getFFI(): FFI { return $this->ffi; }

    public function __call(string $name, array $arguments) { return $this->ffi->$name(...$arguments); }
}
